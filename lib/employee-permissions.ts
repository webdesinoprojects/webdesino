...
export const EMPLOYEE_PERMISSION_LABELS: Record<EmployeePermissionKey, string> = {
  ...
  media: "Media",
  enquiries: "Enquiries",
  "ads-enquiries": "Ads Enquiries",
  "careers-applications": "Career Applications",
...
export const EMPLOYEE_SECTION_PATHS: Record<EmployeePermissionKey, string> = {
  ...
  "ads-enquiries": "/employee/dashboard/ads-enquiries",
  "careers-applications": "/employee/dashboard/careers-applications",

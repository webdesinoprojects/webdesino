    ...
    <main class="bg-white">
      ...
      <section class="relative py-20 lg:py-28 bg-slate-50 overflow-hidden">
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
          <div class="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-[#02066F]/20 to-transparent"></div>
          <div class="absolute bottom-0 left-0 w-96 h-96 bg-[#02066F]/20 rounded-full blur-3xl animate-float"></div>
        </div>
          ...
          <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div class="w-full lg:w-1/3 order-2 lg:order-1">
              <div class="relative group mx-auto max-w-md lg:max-w-none">
                <div class="absolute inset-0 bg-[#02066F] rounded-3xl blur-2xl opacity-50 group-hover:opacity-75 transition-opacity duration-500"></div>
                ...
                <div class="absolute -right-6 top-10 bg-white p-4 rounded-xl shadow-xl hidden md:block animate-float" style="animation-delay: 1s;">
                  <div class="flex items-center gap-3">
                    <div class="p-2 bg-gray-100 rounded-lg text-[#02066F]">
            ...
            <div class="w-full lg:w-2/3 order-1 lg:order-2 text-center lg:text-left">
              <div class="inline-flex items-center gap-2 px-4 py-2 bg-white/10 rounded-full text-[#02066F] font-medium text-sm mb-6 border border-[#02066F]/20">
                <span class="relative flex h-2 w-2">
                  <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-white opacity-75"></span>
                  <span class="relative inline-flex rounded-full h-2 w-2 bg-[#02066F]"></span>
                </span>
                Founder & CEO
              </div>

              <h1 class="text-4xl lg:text-6xl font-bold text-black mb-6 leading-tight">
                Hi, I'm <span class="text-[#02066F]">Rohit Tiwari</span>
              </h1>
              ...
              <div class="flex flex-wrap justify-center lg:justify-start gap-4">
                ...
                <a
                  href="/contact"
                  class="flex items-center gap-2 px-6 py-3 bg-[#02066F] text-white border border-[#02066F] rounded-full font-semibold hover:bg-[#02066F]/90 transition-all hover:-translate-y-1"
                >
      ...
      <section class="py-16 lg:py-24 bg-white">
        <div class="container mx-auto px-4">
          <div class="max-w-4xl mx-auto space-y-16">
            ...
            <div>
              <h2 class="text-3xl font-bold text-[#02066F] mb-6">My Professional Approach</h2>
              ...
              <ul class="space-y-4">
                <li class="flex items-start gap-3 text-slate-700">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check-circle-2 text-[#02066F] mt-1 flex-shrink-0"><circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/></svg>
            ...
            <div>
              <div class=" mb-6">
                <h2 class="text-3xl font-bold text-[#02066F] mb-3">My Expertise</h2>
              </div>

              <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-all border border-slate-100">
                  <div class="w-12 h-12 bg-gray-100 text-[#02066F] rounded-xl flex items-center justify-center mb-6">
            ...
            <div>
              <h2 class="text-3xl font-bold text-[#02066F] mb-6">Achievements and Experience</h2>
              <ul class="space-y-4">
                <li class="flex items-start gap-3 text-slate-700">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-award text-[#02066F] mt-1 flex-shrink-0"><circle cx="12" cy="8" r="6"/><path d="M15.477 12.89 17 22l-5-3-5 3 1.523-9.11"/></svg>
            ...
            <!-- Vision -->
            <div>
              <h2 class="text-3xl font-bold text-[#02066F] mb-6">Vision</h2>
      ...
      <!-- Connect Section -->
      <section class="py-20 bg-slate-50 text-[#02066F] relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 text-center relative z-10">
          ...
          <div class="flex flex-col sm:flex-row justify-center gap-4">
            <a
              href="/contact"
              class="px-8 py-4 bg-white text-[#02066F] rounded-full font-bold hover:bg-gray-50 transition-all shadow-lg"
            >
              Start a Project
            </a>
            <a
              href="https://www.linkedin.com/in/irohittiwari/"
              target="_blank"
              class="px-8 py-4 bg-[#02066F] text-white border border-white rounded-full font-bold hover:bg-black transition-all"
            >
              Follow on LinkedIn
            </a>
          </div>

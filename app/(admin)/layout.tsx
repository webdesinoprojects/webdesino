        ...
        <div className="flex min-h-screen">
          ...
          <aside className="w-64 bg-white border-r border-gray-200 hidden md:block fixed h-full z-10">
            ...
            <nav className="p-4 space-y-2 overflow-y-auto h-[calc(100vh-64px)]">
              ...
              <NavItem href="/admin/projects" icon={<Briefcase size={20} />} label="Portfolio" />
              <NavItem href="/admin/blogs" icon={<FileText size={20} />} label="Blog Posts" />
              <NavItem href="/admin/services" icon={<Settings size={20} />} label="Services" />
              <NavItem href="/admin/clients" icon={<Users size={20} />} label="Clients" />

              <div className="pt-4 pb-2">
                <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Inbox</p>
              </div>

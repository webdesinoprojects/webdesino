...
import { ArrowLeft, Calendar, Mail, Megaphone, Phone, Tag } from "lucide-react";
import { notFound } from "next/navigation";
import EnquiryStatusUpdater from "../../[id]/EnquiryStatusUpdater";
...
export default async function AdsEnquiryDetailsPage({ params }: PageProps) {
  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto">
      <div className="flex items-center gap-4">
        <Link href="/admin/enquiries/ads">
          <Button variant="ghost" size="icon">
            <ArrowLeft className="h-4 w-4" />
          </Button>
        </Link>
        <h1 className="text-2xl font-bold text-blue-900">Ads Enquiry Details</h1>
      </div>

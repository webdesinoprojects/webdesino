      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center">
        <div className="w-full max-w-md rounded-[20px] border border-white/10 bg-white/10 p-10 shadow-[0_20px_60px_rgba(5,8,25,0.45),inset_0_1px_0_rgba(255,255,255,0.18)] backdrop-blur-xl sm:p-12">
          <div className="mb-8 flex flex-col items-center">
            ...
            <p className="mt-2 text-center text-sm text-blue-100/80">Welcome back. Sign in to access your dashboard.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5" aria-busy={isLoading}>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <Label htmlFor="password" className="text-xs font-medium uppercase tracking-wide text-blue-100/75">
                  Password
                </Label>
                <Link
                  href="/admin/forgot-password"
                  className="text-xs font-medium text-cyan-200/90 transition-colors hover:text-cyan-100"
                >
                  Forgot password?
                </Link>
              </div>
            ...
            {isLoading && (
              <p className="text-center text-xs text-blue-100/85">

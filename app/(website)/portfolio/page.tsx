    ...
    <main className="min-h-screen bg-cream py-16 lg:py-24">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-4xl lg:text-6xl font-bold text-center text-[#111184] mb-4">
            ...
            {projects.map((project) => (
              ...
              >
                <div className="relative aspect-[16/9] min-h-[220px] bg-gradient-to-br from-[#111184]/20 to-black/20 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 bg-[#111184] text-white px-3 py-1 rounded-full text-xs font-semibold">
                    {project.industry}
                  </div>
                </div>
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg">
            <h2 className="text-2xl font-bold text-[#111184] mb-6 text-center">
              Industries We Serve
            </h2>
            <div className="flex flex-wrap justify-center gap-3">
              {industries.map((industry) => (
                <span
                  key={industry}
                  className="px-4 py-2 bg-gray-100 text-[#111184] rounded-full font-semibold"
                >
                  {industry}
                </span>
              ))}

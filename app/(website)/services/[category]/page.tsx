  ...
  return (
    <main className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center animate-slide-up">
            <div className="inline-flex items-center justify-center p-4 bg-white rounded-2xl mb-8 backdrop-blur-sm border border-slate-200 shadow-xl">
              {Icon && <Icon size={56} className="text-[#02066F]" />}
            </div>
            ...
            >
              <div className="p-8 md:p-10">
                <div className="flex items-start justify-between mb-6">
                  <h3 className="text-2xl font-bold text-gray-900 group-hover:text-[#02066F] transition-colors">
                    {subtype.title}
                  </h3>
                  <div className="w-10 h-10 bg-gray-50 rounded-full flex items-center justify-center group-hover:bg-[#02066F] group-hover:text-white transition-all duration-300">
                ...
                <div className="space-y-4 mb-8 bg-gray-50 p-6 rounded-xl">
                  {subtype.features.slice(0, 3).map((feature, idx) => (
                    <div key={idx} className="flex items-start gap-3">
                      <CheckCircle2 size={18} className="text-[#02066F] mt-1 shrink-0" />
                ...
                <Link 
                  ...
                  className="block w-full py-3 text-center bg-[#02066F] text-white rounded-lg font-semibold hover:bg-black transition-colors duration-300"
                >
                  Explore Service
                </Link>
              </div>
      ...
      <div className="bg-white py-24 border-t border-gray-100 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#02066F] via-black to-[#02066F]"></div>
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <Link 
            href="/contact"
            className="inline-flex items-center gap-2 px-10 py-5 bg-[#02066F] text-white rounded-full font-bold text-lg hover:bg-black transition-all hover:scale-105 shadow-xl shadow-black/20"
          >

...
export default async function ServicePage({ params }: PageProps) {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="bg-slate-50 border-b border-slate-200 sticky top-0 z-30 backdrop-blur-md bg-slate-50/90">
        <div className="container mx-auto px-4 py-1">
          <div className="flex items-center gap-0.5 text-xs md:text-sm text-slate-600 overflow-x-auto whitespace-nowrap pb-1 scrollbar-hide">
            ...
            <Link href="/services" className="hover:text-[#111184] transition-colors">Services</Link>
            <ChevronRight size={12} className="text-slate-400 flex-shrink-0" />
            <Link href={`/services/${category.slug}`} className="hover:text-[#111184] transition-colors">{category.title}</Link>
            <ChevronRight size={12} className="text-slate-400 flex-shrink-0" />
        ...
        <div className="container mx-auto px-4 py-14 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-slide-in-left">
              <span className="inline-block px-4 py-1.5 bg-white text-[#111184] rounded-full text-sm font-bold mb-6 border border-[#111184]/20 shadow-sm">
                Your Best {service.title} Partner
              </span>
              <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight text-slate-900">
                Expert in <span className="text-[#111184]">{service.title}</span> for Scalable Solutions
              </h1>
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  href="/contact"
                  className="px-8 py-4 bg-[#111184] text-white rounded-full font-bold hover:bg-black transition-all hover:scale-105 shadow-lg shadow-[#111184]/20 flex items-center gap-2"
                >
                  Get Started <ArrowRight size={20} />
                </Link>
                <Link
                  href="#features"
                  className="px-8 py-4 bg-white text-slate-700 rounded-full font-bold hover:bg-slate-50 transition-all border border-slate-200 hover:border-[#111184]"
                >
                  Explore Features
                </Link>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">
              Why Choose <span className="text-[#111184]">Webdesino</span> as your {service.title} Partner?
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={idx} className="p-6 bg-slate-50 rounded-xl border border-slate-100 hover:border-[#111184]/30 transition-all hover:-translate-y-1">
      ...
      {/* Benefits Section */}
      <div className="py-16 bg-[#111184] text-white relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('/grid-pattern.svg')] opacity-5"></div>

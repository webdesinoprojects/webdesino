      ...
      <section className="relative bg-white py-16 lg:py-24 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h1 className="text-4xl lg:text-6xl font-bold text-[#111184] mb-6 animate-fade-in">
              {hero.title || <>Let's Work <span className="text-[#111184]">Together</span></>}
            </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6 animate-fade-in" style={{ animationDelay: '0.3s' }}>
              <div className="glass-strong rounded-3xl p-8">
                <h2 className="text-2xl font-bold text-[#111184] mb-6">Contact Information</h2>
                <div className="space-y-6">
                  ...
                  >
                    <div className="w-12 h-12 rounded-full bg-[#111184]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#111184] group-hover:text-white transition-all">
                      <Phone size={24} className="text-[#111184] group-hover:text-white" />
                    </div>
                    <div>
                  ...
                  >
                    <div className="w-12 h-12 rounded-full bg-[#111184]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#111184] group-hover:text-white transition-all">
                      <Mail size={24} className="text-[#111184] group-hover:text-white" />
                    </div>
                    <div>
                  ...
                  <div className="flex items-start gap-4 p-4 rounded-xl">
                    <div className="w-12 h-12 rounded-full bg-[#111184]/10 flex items-center justify-center flex-shrink-0">
                      <MapPin size={24} className="text-[#111184]" />
                    </div>
                    <div>
              ...
              <div className="glass-strong rounded-3xl p-8">
                <h3 className="text-xl font-bold text-[#111184] mb-4">Business Hours</h3>
          ...
          <div className="mt-16">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                >
                  <MapPin className="mx-auto mb-3 text-[#111184]" size={32} />
                  <h3 className="font-bold text-[#111184] text-lg">{location.name}</h3>

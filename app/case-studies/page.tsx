    ...
    <main className="min-h-screen bg-gradient-to-b from-cream to-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative overflow-hidden">
        ...
        <div className="text-center relative z-10">
          <div className="inline-block glass px-6 py-3 rounded-full text-sm font-semibold mb-6 text-[#02066F] animate-fade-in">
            Real Results, Real Stories
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-[#02066F] mb-6 animate-slide-up">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            <div className="glass-strong rounded-3xl p-8 hover-lift transition-all duration-300 animate-scale-in" style={{ animationDelay: '0.1s' }}>
              <Award className="w-12 h-12 text-[#02066F] mb-4 mx-auto" />
              <p className="text-4xl font-bold text-[#02066F] mb-2">₹6.3Cr+</p>
            ...
            <div className="glass-strong rounded-3xl p-8 hover-lift transition-all duration-300 animate-scale-in" style={{ animationDelay: '0.2s' }}>
              <TrendingUp className="w-12 h-12 text-[#02066F] mb-4 mx-auto" />
              <p className="text-4xl font-bold text-[#02066F] mb-2">330x</p>
            ...
            <div className="glass-strong rounded-3xl p-8 hover-lift transition-all duration-300 animate-scale-in" style={{ animationDelay: '0.3s' }}>
              <Calendar className="w-12 h-12 text-[#02066F] mb-4 mx-auto" />
              <p className="text-4xl font-bold text-[#02066F] mb-2">90 Days</p>
            ...
            <div className="glass-strong rounded-3xl p-8 hover-lift transition-all duration-300 animate-scale-in" style={{ animationDelay: '0.4s' }}>
              <Award className="w-12 h-12 text-[#02066F] mb-4 mx-auto" />
              <p className="text-4xl font-bold text-[#02066F] mb-2">100%</p>
          ...
          {caseStudies.map((study, index) => (
            ...
            >
              ...
              <div className={`p-8 relative overflow-hidden ${
                index === 0 ? 'bg-gradient-to-br from-[#02066F]/5 to-white' :
                index === 1 ? 'bg-gradient-to-br from-white to-[#02066F]/5' :
                index === 2 ? 'bg-gradient-to-br from-[#02066F]/5 to-cream' :
                ...
                <div className="flex items-center justify-between mb-4 relative z-10">
                  <span className="glass px-4 py-2 rounded-full text-sm font-semibold text-[#02066F] shadow-md">
                    {study.industry}
                  </span>
                  <span className="text-sm font-medium text-gray-600">{study.duration}</span>
                </div>
                <h2 className="text-2xl md:text-3xl font-bold text-[#02066F] mb-4 group-hover:text-[#02066F] transition-all relative z-10">
                  {study.client}
                </h2>
              ...
              <div className="p-8 border-t border-gray-100">
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="glass rounded-2xl p-4">
                    ...
                    <p className="text-lg font-bold text-[#02066F]">{study.heroMetrics.revenue}</p>
                  </div>
                  <div className="glass rounded-2xl p-4">
                    <p className="text-sm text-gray-600 mb-1">ROI</p>
                    <p className="text-lg font-bold text-[#02066F]">{study.heroMetrics.roi}</p>
                  </div>
                </div>
                ...
                {/* CTA */}
                <div className="flex items-center justify-between text-[#02066F] font-semibold group-hover:text-[#02066F] transition-colors">

        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-lg text-slate-600 mx-auto">
              <p className="mb-6">
                My journey began with a simple realization: <strong>Most businesses struggle to bridge the gap between having a website and having a digital asset that actually generates revenue.</strong>
              </p>
              <p className="mb-6">

  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link href="/employee/dashboard/pages/new">
            ...
            {pages.map((page) => (
              <TableRow key={page.id}>
                ...
                <TableCell className="text-right">
                  <ActionsMenu id={page.id} editUrl={`/employee/dashboard/pages/${page.id}`} deleteAction={deletePage} />
                </TableCell>
              </TableRow>
            ))}
            {pages.length === 0 && (
              <TableRow><TableCell colSpan={3} className="text-center py-10 text-gray-500">No pages found.</TableCell></TableRow>
            )}
          </TableBody>
        </Table>
      </div>
